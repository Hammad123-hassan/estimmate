...
export default function Hero({ onEstimateBuilt }) {
  ...
  return (
    <section id="home" className="relative overflow-hidden bg-hero-glow pb-12 pt-8 sm:pb-20 sm:pt-14">
      ...
      <div ref={containerRef} className="relative mx-auto max-w-4xl px-4 text-center sm:px-6">
        <p
          data-hero
          className="mb-4 inline-flex max-w-full items-center gap-2 rounded-full border border-brand-200 bg-white/80 px-2.5 py-1 text-[10px] font-bold uppercase tracking-wide text-brand-700 shadow-sm sm:px-3 sm:text-xs"
        >
        ...
        <h1 data-hero className="text-[1.75rem] font-extrabold leading-tight tracking-tight text-ink sm:text-5xl md:text-6xl">
          Client-ready project{' '}
          <span className="text-gradient block sm:inline">estimates in minutes</span>
        </h1>
        <p data-hero className="mx-auto mt-4 max-w-2xl text-sm text-ink-muted sm:mt-5 sm:text-lg">
